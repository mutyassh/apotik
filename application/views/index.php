...
<div id="infodlg" style="display:none"></div> 
    <header class="light_blue"> <!-- Header start -->
        <a href="#" class="logo_image"><span class="hidden-480">APOTIK</span></a>
        <ul class="header_actions pull-left hidden-480 hidden-768">
            ...
            <li rel="tooltip" data-placement="right" title="Change navigation color scheme" class="color_pick navigation_color_pick"><a class="iconic" href="#"><i class="icon-th"></i></a>
                <ul>
                    ...
                    <a class="dark_navigation" href="#">Blue navigation</a>
                </ul>
            </li>
        </ul>
        <ul class="header_actions">
            <li rel="tooltip" data-placement="left" title="Header color scheme" class="color_pick header_color_pick hidden-480"><a class="iconic" href="#"><i class="icon-th"></i></a>
                <ul>
                    <li><a class="white set_color" href="#"></a></li>
            ...
            <li rel="tooltip" data-placement="bottom" title="new messages" class="messages"><a class="iconic" href="#"><i class="icon-envelope-alt"></i></a>
    ...
    <div id="main_navigation" class="white"> <!-- Main navigation start -->
        <div class="inner_navigation">
            <ul class="main">
                <li><a href="<?php echo base_url() ?>jual"><i class="icon-tasks"></i>Data Penjualan</a></li>
                <li><a href="<?php echo base_url() ?>beli"><i class="icon-tasks"></i>Data Pembelian</a></li>
                <li><a href="<?php echo base_url() ?>barang/listbarang"><i class="icon-tasks"></i>Data Barang</a></li>
                <li><a href="<?php echo base_url() ?>supplier/listsupplier"><i class="icon-tasks"></i>Data Suplier</a></li>
                <li><a href="<?php echo base_url() ?>customer/listCustomer"><i class="icon-tasks"></i>Data Laporan Transaksi</a></li>
